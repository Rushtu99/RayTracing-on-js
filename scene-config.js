...
export async function setupScene(objData = null) {
    ...
    let position = new Vector(40, 80, -100);
    ...
    scene = {
        ...
        objects: [
            ...meshes,
            new Sphere(new Vector(100, 0, 0), 20, new RefractedMaterial(Color(223, 255, 0), 2)), // Yellow, refractive (n=2)
            new Sphere(new Vector(0, 100, 0), 12, new RefractedMaterial(Color(223, 255, 0), 1 / 2.0)), // Yellow, refractive (n=0.5)
            new Sphere(new Vector(41, 0, 10), 20, new DiffusedMaterial(Color(46, 35, 108))), // Dark blue, diffuse
            new Sphere(new Vector(-41, 0, 10), 20, new ReflectedMaterial(Color(223, 255, 0), 0.01)), // Yellow, reflective
            new Sphere(new Vector(0, 0, 60), 10, new EmmisiveMaterial(Color(255, 191, 0))), // Orange, emissive

            new Sphere(new Vector(0, 0, -10), 20, new DiffusedMaterial(new Vector(1, 0.01, 0.01), 0.1, 0.5)), // Red, diffuse
            new Sphere(new Vector(-60, 30, -30), 30, new EmmisiveMaterial(new Vector(0.5, 1, 0.95), 0.0, 0.0, 0)), // Cyan, emissive
            // new Sphere(new Vector(0, 0, 0), 20, new RefractedMaterial(new Vector(0.1, 1, 0.1), 0.3, 0.1)), // Green, refractive
            // new Sphere(new Vector(40, 50, 200), 60, new ReflectedMaterial(new Vector(0.05, 0.05, 1), 0.5, 0.8)), // Blue, reflective

            new Sphere(new Vector(0, -2020, 0), 2000, new DiffusedMaterial(Color(108, 3, 69), 0.2, 0.2, 5), true), // Purple, diffuse (ground)]
        ]
        }
